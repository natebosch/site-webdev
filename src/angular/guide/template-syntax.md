...
<div class="l-sub-section" markdown="1">
  ...
  [ViewChild](/angular/api/angular.core/ViewChild-class.html) and
  [ContentChild](/angular/api/angular.core/ContentChild-class.html).
</div>
...
<div class="l-sub-section" markdown="1">
  ...
  supported by a [ControlValueAccessor](/angular/api/angular.common/ControlValueAccessor-class.html)
...
<div class="l-sub-section" markdown="1">
  ...
  and `odd` in the [NgFor API reference](/angular/api/angular.common/NgFor-class.html).
</div>
...
[NgForm](/angular/api/angular.common/NgForm-class.html "API: NgForm")
